          ...
          <ul className="space-y-2 font-medium">
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-bark hover:bg-blue-100 dark:hover:bg-blue-300 group"
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-blue-600"
                  xmlns="http://www.w3.org/2000/svg"
                  width="56"
                  height="56"
                  viewBox="0 0 56 56"
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-bark hover:bg-gray-100 dark:hover:bg-blue-300 group"
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-blue-600"
                  xmlns="http://www.w3.org/2000/svg"
